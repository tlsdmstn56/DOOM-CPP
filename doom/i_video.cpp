...
void grabsharedmemory(int size)
{
  ...
  fprintf(stderr, "shared memory id=%d, addr=0x%x\n", id,
	  reinterpret_cast<int64_t>(image->data));
}
  ...
  double*	xline )
{
	...
	do
	{
	    ...
	    dpixel = *(double *)( reinterpret_cast<int64_t>(exp) + ( (fourpixels&0xffff0000)>>13) );
	    xline[0] = dpixel;
	    xline[160] = dpixel;
	    xline[320] = dpixel;
	    xline[480] = dpixel;
			
	    dpixel = *(double *)( reinterpret_cast<int64_t>(exp) + ( (fourpixels&0xffff)<<3 ) );
	    xline[1] = dpixel;
	    xline[161] = dpixel;
	    xline[321] = dpixel;
	    xline[481] = dpixel;
