...
//	M_Menu.C
//
constexpr const char* PRESSKEY = "press a key.";
constexpr const char* PRESSYN = "press y or n.";
...
//
constexpr char * CC_ZOMBIE = "ZOMBIEMAN";
constexpr char * CC_SHOTGUN = "SHOTGUN GUY";
constexpr char * CC_HEAVY = "HEAVY WEAPON DUDE";
constexpr char * CC_IMP = "IMP";
constexpr char * CC_DEMON = "DEMON";
constexpr char * CC_LOST = "LOST SOUL";
constexpr char * CC_CACO = "CACODEMON";
constexpr char * CC_HELL = "HELL KNIGHT";
constexpr char * CC_BARON = "BARON OF HELL";
constexpr char * CC_ARACH = "ARACHNOTRON";
constexpr char * CC_PAIN = "PAIN ELEMENTAL";
constexpr char * CC_REVEN = "REVENANT";
constexpr char * CC_MANCU = "MANCUBUS";
constexpr char * CC_ARCH = "ARCH-VILE";
