  ...
  mobj_t* thing )
{
 ...
 if ( !p )
     return 0;
 if (!p->cards[static_cast<int>(Card::it_bluecard)] && !p->cards[static_cast<int>(Card::it_blueskull)])
 {
     p->message = PD_BLUEO;
 ...
 if ( !p )
     return 0;
 if (!p->cards[static_cast<int>(Card::it_redcard)] && !p->cards[static_cast<int>(Card::it_redskull)])
 {
     p->message = PD_REDO;
     S_StartSound(NULL,sfx_oof);
     return 0;
 ...
 if ( !p )
     return 0;
 if (!p->cards[static_cast<int>(Card::it_yellowcard)] &&
     !p->cards[static_cast<int>(Card::it_yellowskull)])
 {
  ...
  mobj_t* thing )
{
 ...
 if (!player->cards[static_cast<int>(Card::it_bluecard)] && !player->cards[static_cast<int>(Card::it_blueskull)])
 {
 ...
 if (!player->cards[static_cast<int>(Card::it_yellowcard)] &&
     !player->cards[static_cast<int>(Card::it_yellowskull)])
 {
 ...
 if (!player->cards[static_cast<int>(Card::it_redcard)] && !player->cards[static_cast<int>(Card::it_redskull)])
 {
